                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', paddingHorizontal: 30, width: '100%', height: 150, marginTop: 50 }}>
                        ...
                        <TouchableOpacity
                            ...
                            <AnimatedCircularProgress
                                ...
                                width={6}
                                rotation={90}
                                fill={parseFloat(profileData.targets?.step !== undefined && parseFloat(profileData.targets.step) / parseFloat(Steps)).toFixed(0)}
                                tintColor="#CCCC00"
                        ...
                        <TouchableOpacity
                            ...
                            style={{ justifyContent: 'center', alignItems: 'center', width: '45%' }}>
                                <AnimatedCircularProgress
                                    ...
                                    width={6}
                                    rotation={90}
                                    fill={parseFloat(profileData.targets?.calorie !== undefined && parseFloat(profileData.targets.calorie) / parseFloat(Calories)).toFixed(0)}
                                    tintColor="green"
                                    backgroundColor="#2d2d2d">
                                    {(fill) => (
                                        <View style={{ justifyContent: 'center', alignItems: 'center' }}>
