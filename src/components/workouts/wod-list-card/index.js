                        ...
                        <View style={{ flexDirection: 'row', width: '70%' }}>
                            ...
                            <View style={{ marginLeft: 15 }}>
                                ...
                                {workouts.item.type === "time" ?
                                    <Text numberOfLines={2} style={styles.moveText}>{workouts.item.set + ' Set, ' + workouts.item.time + ' Saniye'}</Text>
                                    :
                                    <Text numberOfLines={2} style={styles.moveText}>{workouts.item.set + ' Set, ' + workouts.item.reps + ' Tekrar'}</Text>
                                }
                            </View>
                        </View>
